...
class CharactersAdapterMain:
    PagingDataAdapter<GetCharacterByIdResponse, CharacterItemViewHolder>(CharactersDiffUtilMain()) {

    var onItemClickListener: ((GetCharacterByIdResponse) -> Unit)? = null
